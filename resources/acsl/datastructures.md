...
| --- | --- | --- |
| | <img src="/res/acsl/datastructures/delete0.png" class="img-fluid" /> | *I* has been removed. Since it had *no* children, no shifts needed to be made.
| <img src="/res/acsl/datastructures/insert8.png" class="img-fluid" /> | <img src="/res/acsl/datastructures/delete1.png" class="img-fluid" /> | *R* has been removed. Since it had *1* child, that child was moved up to be on the right of *M*. Since *N* comes after *M*, this shift is valid. |
| | <img src="/res/acsl/datastructures/delete2.png" class="img-fluid" /> | *M* has been removed. So, the left branch of *M* is moved up to take *M*'s place. *M*'s right branch is placed to the right of that branch. |
