...
*   **4-day** window to begin the contest
...
*   Problems are submitted online, and can be coded using a variety of languages
    *   C++ 11, C++, C, Java 8 (1.8.0_121 JRE), Python 2 (2.7.6), Python 3 (3.4.0), Pascal
...
*   Problems are graded automatically by the USACO system.
    *   The amount of test cases will vary by problem (typically around 10). Each of them are worth an equivalent amount of points, and the total point value of all of them is 333.
    ...
    *   There is **no penalty** for resubmitting.
        *   If there are multiple submissions, the LAST submission you submitted will be counted as your score.
    ...
    *   Once your program passes initial compilation, it will be run against all the test cases. There are a few codes for what caused a test case to fail.
        *   T: Timeout (you are provided 4 seconds (2 in every language but Java) for your code to successfully run and return a solution)
...
However, the **US Open,** which serves as USACO’s national championship, has a few differences (everything else is the same).
...
*   **Silver**
    ...
    *   To pass, you must be able to:
        *   Know how to use trees and basic graphs. (TREES ALMOST ALWAYS SHOW UP ON AT LEAST ONE PROBLEM IN SILVER!).
        *   Prefix Sum (this is fairly common and often used in a greedy algorithm)
        *   Know data structures, such as maps, sets, and trees.
            *   Hash (HashMap, HashSet, etc.) is EXTREMELY helpful here to optimize your code.
        *   Be able to come up with efficient, optimal solutions for problems.
*   **Gold**
...
*   **Platinum**
    ...
    *   To be successful in this level, you need to have:
        *   A sophisticated understanding of how computing functions
        *   Incredible proficiency in number theory 
        *   A highly developed understanding of time/space complexity
        *   A creative perspective to unique problems
